    ...
    return(
        <div>
            ...
            <div>
                ...
                <div>
                    <button type='submit' className="bg-[#E66240] text-white px-4 py-2 rounded-[16px]">Save</button>
                    <button type='button' onClick={()=>navigate('/profile')}
                     className="border border-gray-300 px-4 py-2 rounded-[16px]">Back</button>
            </div>
            </form>
        </div>
    )
