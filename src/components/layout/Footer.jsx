export default function Footer() {
  return (
    <footer className="bg-white mt-auto py-16 pb-8 md:py-16 md:pb-8">
      <div className="max-w-6xl mx-auto px-4 md:px-6 flex flex-col items-center gap-6 text-center">
        {/* Logo */}
        <div className="font-display text-2xl font-bold text-ink cursor-pointer transition-colors hover:text-primary">
          RetrieveApp
        </div>

        {/* Contact Info */}
        <div className="flex flex-col gap-3 items-center">
          <p className="font-medium text-ink text-base">Got questions?</p>
          <div className="text-gray600 text-sm flex items-center justify-center gap-3 flex-col md:flex-row">
